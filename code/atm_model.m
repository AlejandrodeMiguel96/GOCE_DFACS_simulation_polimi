...
%% Exponential Atmospheric model. Source: Wertz, 1979,820
% PROTOTYPE
%   rho = atm_model(h)
% INPUT
%   h: altitude [km]
...
%   rho: density [kg/km^3]
%
% Matrix columns meaning
% data=[minimum altitude interval[km] ,maximum altitude interval[km], base altitude[km], nominal density[kg/m^3], scale height[km]]
...
rho = rho_0*exp(-(h-h_base)/H)*1e9; %[kg/km^3]
end %atm_model
